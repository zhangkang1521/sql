...
select borrowid,userid,type,substr(name,0,15) as name,account,loanaccount,accountyes,apr,paymentmethod as pmethod,TIMELIMIT,period,periodUnit as pUnit,status,addtime,version,pledgeType,content
FROM XXD_BORROW
--WHERE TYPE=17
--where name like '%1723车主%'
--where borrowid='BW201610260006'
order by addtime desc;

update xxd_borrow set timelimit=1 where borrowid='BW201610190014'
delete from xxd_borrow where borrowid='BW201609219981'
...
WHERE BORROWID='BW201611090055'
--and userid=115641
--where TENDERID='BT2016110402767'
--where isoptimize=1
order by addtime desc;
